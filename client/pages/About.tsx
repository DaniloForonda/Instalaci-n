    ...
    <div className="bg-white">
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto space-y-6 mb-20 text-lg text-gray-700 leading-relaxed">
            <p className="text-xl text-black font-medium leading-relaxed">
              ¿Cómo se ve el dolor? ¿Cómo se lleva algo tan individual e interno
              a la pantalla? ¿De qué manera se entiende el dolor de la otredad?
            </p>

            <p>
              Hystera es una instalación que se vale de las posibilidades de lo
              digital para crear una experiencia que apele a la emocionalidad, a
              la empatía por el dolor ajeno a través de la incomodidad.
            </p>
            ...
            <p>
              ¿Por qué hablar de dolor menstrual? La endometriosis, además de
              ser sumamente dolorosa, es una enfermedad difícil de diagnosticar;
              esto se debe no solo a la escasa investigación al respecto, sino
              también a la normalización del dolor de las personas menstruantes.
            </p>

            <p>
              Hystera busca que las personas que elijan vivir esta experiencia
              se acerquen un poco a lo que es sobrevivir con la enfermedad. La
              obra juega con múltiples estímulos para lograr esta experiencia:
              sensores que captan algunos datos del cuerpo, una silla
              construida para causar incomodidad, luz, sonido y una proyección
              que muestra cómo los datos aportados por quien participa afectan lo
            ...
            <p>
              ...
              interactúan con la obra; el dolor real que viven las personas con
              endometriosis no para, está ahí, presente en su día a día, y cada
              persona, a pesar de la incomodidad, debe continuar.
            </p>
          </div>
